...
public class LinkedListIterable<AnyType> implements Iterable<AnyType>
{
     ...
     *  Complexity: O(n^2)
     */
    public LinkedListIterable<AnyType> copy1()
    {
        LinkedListIterable<AnyType> twin = new LinkedListIterable<AnyType>();
        Node<AnyType> tmp = head;
        while(tmp != null)
        {
     ...
     *  Complexity: O(n)
     */
    public LinkedListIterable<AnyType> copy2()
    {
        LinkedListIterable<AnyType> twin = new LinkedListIterable<AnyType>();
        Node<AnyType> tmp = head;
        while(tmp != null)
     ...
     *  Complexity: O(n)
     */
    public LinkedListIterable<AnyType> reverse()
    {
        LinkedListIterable<AnyType> list = new LinkedListIterable<AnyType>();
        Node<AnyType> tmp = head;
        while(tmp != null)
        {
     ...
     *  Complexity: O(n)
     */
    public LinkedListIterable<AnyType> copy3()
    {
        LinkedListIterable<AnyType> twin = new LinkedListIterable<AnyType>();
        Node<AnyType> tmp = head;
    ...
    {
        LinkedListIterable<String> list = new LinkedListIterable<String>();
        list.addFirst("p");
        list.addFirst("a");
        list.addFirst("e");
        list.addFirst("h");
        ...
        LinkedListIterable<String> twin = list.copy3();
